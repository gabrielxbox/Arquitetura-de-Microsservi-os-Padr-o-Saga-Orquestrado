...
public class KafkaConfig {
    ...
    private static final Integer PARTITIONE_COUNT = 1;
    private static final Integer REPLICATION_CONT = 1;
    ...
    private java.util.Map<String, Object> consumerProps() {
    ...
    private java.util.Map<String, Object> producerProps() {
        java.util.Map<String, Object> props = new java.util.HashMap<>();
    ...
    // TODO criação de topic se não existir
    @Bean
    public NewTopic buildTopic(String name) {
        return TopicBuilder.name(name)
                .replicas(PARTITIONE_COUNT)
                .partitions(REPLICATION_CONT)
                .build();
    }
